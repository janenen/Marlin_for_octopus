 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        180 // Seconds//jan
  #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                180 // Seconds//jan
...
#define E2_AUTO_FAN_PIN FAN3_PIN//same hotend
 ...
 */
#define DUAL_X_CARRIAGE//jandual
#if ENABLED(DUAL_X_CARRIAGE)
  #define X1_MIN_POS X_MIN_POS    // Set to X_MIN_POS
  #define X1_MAX_POS X_BED_START_POS+X_BED_SIZE   // A max coordinate so the X1 carriage can't hit the parked X2 carriage
  #define X2_MIN_POS    X_BED_START_POS        // A min coordinate so the X2 carriage can't hit the parked X1 carriage
  ...
  #define DEFAULT_DUPLICATION_X_OFFSET X_BED_SIZE/2 //like comment above
...
//
  ...
  //#define Z_MULTI_ENDSTOPS          // Other Z axes have their own endstops//jandual faster than G34, (how to combine dual endstops and probe to bed)
...
#define QUICK_HOME                          // If G28 contains XY do a diagonal move first//jan
...
// @section bltouch
   ...
   */
  #define BLTOUCH_HS_MODE true//jan
...
//
#define ASSISTED_TRAMMING//jan
#if ENABLED(ASSISTED_TRAMMING)

  // Define positions for probe points.
  #define TRAMMING_POINT_XY { {  50, 50 }, { 220-50,  50 }, { 220-50, 220-50 }, { 50, 220-50 } }
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING//jan
...
// LCD Print Progress options
   ...
   */
  #define SDCARD_SORT_ALPHA220//jan
...
#define LIN_ADVANCE
  ...
  //#define EXPERIMENTAL_SCURVE // Allow S-Curve Acceleration to be used with LA.//jan
 ...
 */
  ...
  #define TOOLCHANGE_FILAMENT_SWAP
    ...
    #define TOOLCHANGE_FS_EXTRA_PRIME          1  // (mm) Extra priming length
 ...
 */
#define ADVANCED_PAUSE_FEATURE//jan
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         45  // (mm/s) Initial retract feedrate.//jan
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     20  // (mm/s) Unload filament feedrate. This can be pretty fast.//jan
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      51  // (mm) The length of filament for a complete unload.//jan
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   12  // (mm/s) Load filament feedrate. This can be pretty fast.//jan
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           90  // (seconds) Time limit before the nozzle is turned off for safety.//jan
  #define FILAMENT_CHANGE_ALERT_BEEPS         10  // Number of alert beeps to play when a response is needed.
  #define PAUSE_PARK_NO_STEPPER_TIMEOUT           // Enable for XYZ steppers to stay powered on during filament change.
  //#define FILAMENT_CHANGE_RESUME_ON_INSERT      // Automatically continue / load filament when runout sensor is triggered again.
  //#define PAUSE_REHEAT_FAST_RESUME              // Reduce number of waits by not prompting again post-timeout before continuing.

  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change.//jan
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES           // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.//jan
